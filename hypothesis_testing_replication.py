...
loaded_file = f"results/mmd/hypothesis_testing_sv_{mode}_{estimation_type}stat_2.xlsx"
...
axes[0].set_title("KDE for Variables 1 to 10")
...
axes[1].set_title("KDE for Variables 11 to 20")
