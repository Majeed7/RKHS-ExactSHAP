...
if plot_only:
    ...
    plt.tight_layout()
    fig.savefig(f"results/syn/localexp_syn_boxplot.pdf", dpi=800, format='pdf', bbox_inches='tight')
    plt.show()
    ...
    plt.tight_layout()
    fig.savefig(f"results/syn/localexp_syn_execution_time.pdf", dpi=800, format='pdf', bbox_inches='tight')
    plt.show()
